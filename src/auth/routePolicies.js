...
export const ROUTE_POLICIES = [
  ...
  // AI connections / proxy / voice / SMTP
  { method: "GET", path: "/settings/connections/flags", access: "session", permission: "settings.view", csrf: false },
  { method: "GET", path: "/settings/proxy-profiles", access: "session", permission: "manage_proxy_profiles", csrf: false },
  { method: "POST", path: "/settings/proxy-profiles", access: "session", permission: "manage_proxy_profiles", csrf: true },
  { method: "PATCH", path: "/settings/proxy-profiles/:id", access: "session", permission: "manage_proxy_profiles", csrf: true },
  { method: "DELETE", path: "/settings/proxy-profiles/:id", access: "session", permission: "manage_proxy_profiles", csrf: true },
  { method: "POST", path: "/settings/proxy-profiles/:id/test", access: "session", permission: "manage_proxy_profiles", csrf: true },
  { method: "GET", path: "/settings/ai/providers", access: "session", permission: "use_ai_provider", csrf: false },
  { method: "POST", path: "/settings/ai/providers", access: "session", permission: "manage_ai_providers", csrf: true },
  { method: "GET", path: "/settings/ai/providers/:id", access: "session", permission: "use_ai_provider", csrf: false },
  { method: "PATCH", path: "/settings/ai/providers/:id", access: "session", permission: "manage_ai_providers", csrf: true },
  { method: "DELETE", path: "/settings/ai/providers/:id", access: "session", permission: "manage_ai_providers", csrf: true },
  { method: "POST", path: "/settings/ai/providers/:id/test", access: "session", permission: "manage_ai_providers", csrf: true },
  { method: "POST", path: "/settings/ai/providers/:id/sync-models", access: "session", permission: "manage_ai_models", csrf: true },
  { method: "GET", path: "/settings/ai/models", access: "session", permission: "use_ai_provider", csrf: false },
  { method: "GET", path: "/settings/ai/models/available", access: "session", permission: "select_chat_model", csrf: false },
  { method: "POST", path: "/settings/ai/models", access: "session", permission: "manage_ai_models", csrf: true },
  { method: "PATCH", path: "/settings/ai/models/:id", access: "session", permission: "manage_ai_models", csrf: true },
  { method: "DELETE", path: "/settings/ai/models/:id", access: "session", permission: "manage_ai_models", csrf: true },
  { method: "GET", path: "/settings/ai/user", access: "session", permission: "select_chat_model", csrf: false },
  { method: "PUT", path: "/settings/ai/user", access: "session", permission: "select_chat_model", csrf: true },
  { method: "GET", path: "/profiles/variables", access: "session", permission: "profiles.view", csrf: false },
  { method: "POST", path: "/profiles/preview", access: "session", permission: "manage_prompt_profiles", csrf: true },
  { method: "POST", path: "/profiles/:id/duplicate", access: "session", permission: "manage_prompt_profiles", csrf: true },
  { method: "GET", path: "/profiles/:id/versions", access: "session", permission: "manage_prompt_profiles", csrf: false },
  { method: "POST", path: "/profiles/:id/versions/:vid/restore", access: "session", permission: "manage_prompt_profiles", csrf: true },
  { method: "POST", path: "/profiles/:id/assign", access: "session", permission: "assign_prompt_profiles", csrf: true },
  { method: "POST", path: "/voice/transcribe", access: "session", permission: "use_voice_input", csrf: true, rateLimit: "llm" },
  { method: "GET", path: "/settings/email/accounts", access: "session", permission: "manage_communication_accounts", csrf: false },
  { method: "POST", path: "/settings/email/accounts", access: "session", permission: "manage_communication_accounts", csrf: true },
  { method: "PATCH", path: "/settings/email/accounts/:id", access: "session", permission: "manage_communication_accounts", csrf: true },
  { method: "DELETE", path: "/settings/email/accounts/:id", access: "session", permission: "manage_communication_accounts", csrf: true },
