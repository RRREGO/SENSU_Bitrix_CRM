...
const actionCatalog = [
  ...
  { name: "communication_message_send_prepare", description: "Prepare отправки через Hub/Safety (не шлёт само)", params: { contactId: "number", channel: "whatsapp", body: "string" }, destructive: false, implemented: true },
